...
:dockerready
echo Docker is ready. Starting the app, this can take a few minutes the first time...
...
if %WEB_TRIES% GTR 60 goto webtimeout
ping -n 3 127.0.0.1 >nul
curl -s -o nul http://localhost:5174
if errorlevel 1 (
...
:webtimeout
echo.
echo The website did not respond in time. Showing container status:
docker compose ps
echo.
...
echo Login: 01000000000  /  password123
